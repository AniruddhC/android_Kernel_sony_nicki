...
#endif/*MTD-CONN-EH-USBPORTING-00-}*/
...
/*CONN-EH-PCCOMPANION-00+{*/
	...
	config->fsg.vendor_name = "SONY";/*MTD-CONN-EH-USBPORTING-00+*/
	config->fsg.product_name = "Mass storage";/*MTD-CONN-EH-USBPORTING-00+*/
#endif
/*CONN-EH-PCCOMPANION-00+}*/
...
static struct android_usb_function *supported_functions[] = {
	...
	&adb_function,
	&ccid_function,
//	&acm_function,  /*MTD-CONN-EH-USBPORTING-00-*/
	&mtp_function,
	&ptp_function,
#ifdef CONFIG_USB_ANDROID_CDC_ECM
	&ecm_function,
...
static void android_disconnect(struct usb_gadget *gadget)
{
	...
	printk(KERN_INFO"usb:%s\n", __func__);/*MTD-CONN-EH-USBPORTING-00+*/
