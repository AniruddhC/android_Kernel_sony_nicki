...
#if defined(CONFIG_MT9V115) || defined(CONFIG_HM03D5)
...
static struct camera_vreg_t msm_8930_mt9v115_vreg[] = {
    {"cam_none", REG_LDO, 0, 0, 0},
    //{"cam_vana", REG_LDO, 2800000, 2850000, 85600},//Use GPIO76 to control on/off
    //{"cam_vdig", REG_LDO, 1200000, 1200000, 105000},//Use GPIO96 to control on/off
    //{"cam_vio", REG_LDO, 1800000, 1800000, 16000},//Use GPIO96 to control on/off
...
static struct msm_camera_csi_lane_params mt9v115_csi_lane_params = {
	.csi_lane_assign = 0xE4,
	.csi_lane_mask = 0x1,// 1 Lane
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_mt9v115 = {
	.mount_angle	= 90,
	.cam_vreg	= msm_8930_mt9v115_vreg,
	.num_vreg	= ARRAY_SIZE(msm_8930_mt9v115_vreg),
	.gpio_conf	= &fih_front_cam_gpio_conf,
	.csi_lane_params = &mt9v115_csi_lane_params,
};
